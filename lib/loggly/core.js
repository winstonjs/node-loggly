...
Loggly.prototype.log = function (inputId, msg, callback) {
  var message = msg instanceof Object ? querystring.stringify(msg, ',') : msg
  var logOptions = {
...
Loggly.prototype.search = function (/* query, [options], callback */) {
  ...
  var searchOptions = {
    uri: this.logglyUrl('search?' + querystring.stringify(opts)),
    auth: this.config.auth
  };
...
Loggly.prototype.facet = function (/* facet, query, [options], callback */) {
  ...
  var facetOptions = {
    uri: this.logglyUrl('facets', facet, '?' + querystring.stringify(opts)),
    auth: this.config.auth
  };
